        ...
        <form method="POST" action="{{ route('products.store') }}" class="grid gap-4 md:grid-cols-2">
            ...
            <div class="md:col-span-2 rounded-lg border border-slate-200 p-4">
                ...
                <div class="grid gap-3 sm:grid-cols-3">
                    <label class="inline-flex items-center gap-2 text-sm text-slate-700">
                        <input id="is_batch_enabled" type="checkbox" name="is_batch_enabled" value="1" class="rounded border-slate-300" @checked(old('is_batch_enabled'))>
                        Enable Batch
                    </label>
                    <label class="inline-flex items-center gap-2 text-sm text-slate-700">
                        <input id="has_expiry" type="checkbox" name="has_expiry" value="1" class="rounded border-slate-300" @checked(old('has_expiry'))>
                        Enable Expiry
                    </label>
                    <label class="inline-flex items-center gap-2 text-sm text-slate-700">
                        <input id="has_mrp" type="checkbox" name="has_mrp" value="1" class="rounded border-slate-300" @checked(old('has_mrp'))>
                        Enable MRP
                    </label>
                </div>
