        ...
        <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
            <div class="mb-4 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
                <div class="grid w-full grid-cols-1 gap-2 sm:flex sm:w-auto sm:flex-wrap">
                    <a href="{{ route('reports.profit', array_merge($filters, ['export' => 'pdf'])) }}" class="w-full rounded-lg border border-rose-300 px-4 py-2.5 text-center text-sm font-medium text-rose-700 hover:bg-rose-50 sm:w-auto">Export PDF</a>
                    <a href="{{ route('reports.profit', array_merge($filters, ['export' => 'excel'])) }}" class="w-full rounded-lg border border-emerald-300 px-4 py-2.5 text-center text-sm font-medium text-emerald-700 hover:bg-emerald-50 sm:w-auto">Export Excel</a>
                    <a href="{{ route('reports.profit', array_merge($filters, ['export' => 'print'])) }}" target="_blank" class="w-full rounded-lg border border-sky-300 px-4 py-2.5 text-center text-sm font-medium text-sky-700 hover:bg-sky-50 sm:w-auto">Print</a>
                </div>
            </div>
